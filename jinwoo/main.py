...
def main():
    ...
    input_dir = "/data/jinwoo/target_data/acadj_11.mp4"
    result_dir = "/data/jinwoo/result_trainend_timestamp_rr"
    
    full_transcription = inference_on(input_dir, model, processor, segment_length_sec=30)
    print("Inference 결과:")
    print(full_transcription)

    result_dir = "/data/jinwoo/result_trainend_time"
    ...
    # model, processor = load_model_and_processor()
    # input_dir = "/data/seungmin/dataset/kr_univ_lec/training/source/eng/arch/C01750/"
    # result_dir = "/data/jinwoo/result_trainend_timestamp_rr"
    # os.makedirs(result_dir, exist_ok=True)
    ...
    #         full_transcription = inference_on(file_path, model, processor, segment_length_sec=30)
    #         print("Inference 결과:")
    #         print(full_transcription)
